                    ...
                    >
                        <div className="keep-in-touch__form-fields">
                            ...
                            <div className="keep-in-touch__textarea-wrap">
                                ...
                                <div className="keep-in-touch__textarea-counter">
                                    ...
                                    {translate("common.from", lang)}{" "}
                                    {commentMaxLength}{" "}
                                    {translate("common.symbols", lang)}
                                </div>
                            </div>
                        </div>
                        <div className="keep-in-touch__submit">
                            {serverError && (
                                ...
                                >
                                    <div
                                        className="keep-in-touch__close"
                                    ...
                                    <div className="keep-in-touch__message-header">
                                        ...
                                        {translate(
                                            "keepInTouch.messages.errorHeader",
                                            lang,
                                        )}
                                        <i className="icon-about-arrow" />
                                    </div>
                            ...
                            {success && (
                                ...
                                >
                                    ...
                                    <div className="keep-in-touch__message-header">
                                        <i className="icon-about-arrow" />
                                        {translate(
                                            "keepInTouch.messages.successHeader",
                                            lang,
                                        )}
                                        <i className="icon-about-arrow" />
                                    </div>
                            ...
                            <button type="submit">
                                <i className="icon-about-arrow" />
                                <span>
                                    {translate("keepInTouch.button", lang)}
                                </span>
                                <i className="icon-about-arrow" />
                            </button>
                        </div>
