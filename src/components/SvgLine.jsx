...
const MOBILE_SVG_PATH = "m 399,481 c -23,-21 -48,-44 -80,-50 -30,-2 -54,21 -69,45 -15,23 -33,46 -58,58 -25,10 -52,-2 -69,-20 -16,-14 -35,-31 -57,-26 -27,8 -37,39 -62,51 -4,3 -11,3 -11,8 l -14,303 c 0,-24 15,58 51,76 36,18 94,11 127,11 33,0 84,0 138,25 54,25 99,58 117,54 l -15,120 c 3,72 -33,145 -46,162 -12,17 -29,48 -68,48 -39,0 -76,-35 -117,-23 -40,12 -52,49 -84,71 -33,23 -51,20 -65,30 -14,10 -17,18 -26,29 l -1,337 c 0,0 42,8 72,22 30,14 58,41 80,64 22,23 45,47 61,61 16,14 19,19 57,36 28,9 55,13 98,9 41,-6 62,-25 68,-27 l 20,237 c 3,75 -12,151 -22,178 -11,27 -48,93 -88,93 -40,0 -88,-48 -113,-72 -25,-24 -39,-53 -84,-50 -46,3 -57,95 -122,119 -64,24 -37,172 -46,184 l -16,240 c 2,24 2,46 20,68 18,22 12,30 56,40 44,10 122,-15 156,15 35,29 27,67 39,115 12,47 30,79 68,104 37,25 83,7 113,0 30,-7 30,-14 30,-14 l -36,533 c 3,73 -34,147 -46,164 -12,17 -29,48 -69,48 -39,0 -77,-35 -118,-23 -41,12 -52,49 -86,72 -33,23 -52,20 -66,30 -14,10 -17,18 -26,29 l -4.464424,347.3622 c 0,0 49.464424,8.6378 77.464424,22.6378 28,13 53,38 73,59 21,21 41,43 56,56 14,12 18,18 53,33 26,8 51,11 90,8 38,-5 57,-23 62,-25";
...
const SvgLine = () => {
    ...
    useEffect(() => {
        ...
        function computeZones() {
            ...
            // Use ScrollTrigger for pinStart — reliable with ScrollSmoother
        ...
        function getVisualProgress(scrollY) {
            ...
            if (scrollY <= pinStart) {
                ...
                const restProgress =
                    restVirtual > 0 ? (scrollY - pinEnd) / restVirtual : 1;
